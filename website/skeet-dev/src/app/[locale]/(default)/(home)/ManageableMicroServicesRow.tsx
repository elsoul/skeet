...
export default function ManageableMicroServicesRow() {
  ...
  return (
    <>
      ...
      >
        ...
        >
          {t('(home).ManageableMicroServicesRow.title')}
        </h2>
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-7">
          <div className="hidden sm:col-span-4 sm:block" />
          <div className="px-16 sm:col-span-3 sm:px-0">
            <Image
              src={MonorepoArchitectureImg}
              alt={t('(home).ManageableMicroServicesRow.title')}
              className="w-full"
              unoptimized
              width={256}
              height={256}
          ...
          <div className="sm:col-span-4">
            ...
            >
              {t('(home).ManageableMicroServicesRow.summary')}
            </h3>
            <p
              className={cn(
            ...
            >
              {t('(home).ManageableMicroServicesRow.description')}
            </p>
            <div className="flex flex-wrap items-center justify-start gap-3 pt-6">
              ...
              >
                <Button>
                  ...
                  {t('(home).ManageableMicroServicesRow.button1')}
                </Button>
              </Link>
              <Link href={DEFAULT_PATHS.doc}>
                <Button variant="outline">
                  {t('(home).ManageableMicroServicesRow.button2')}
                </Button>
              </Link>
            </div>
          </div>
